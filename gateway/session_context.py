...
# Profile namespace that owns delivery for this messaging session. The gateway
# stamps this at dispatch so kanban auto-subscribe can tag notify subs with the
# profile whose notifier should deliver — not the worker's HERMES_PROFILE.
